...
public class SolicitarVacacionesPasadas extends javax.swing.JFrame {
    ...
    String idAgnt;
    Date fechaInicioVacaciones;
    Date fechaFinVacaciones;
    VacacionesDisponibles objVacacionesDisponibles = null;
    int totalVaca;

    public SolicitarVacacionesPasadas(String idAgente) {
...
//            System.out.println("dias :" + diferenciaEnDias);
                ...
                if ((totalVaca - diferenciaEnDias) < 0) {
                    JOptionPane.showMessageDialog(null, "Estas excediendo la cantidad de dias disponibles \n Cuentas con: " + totalVaca, "Advertencia", JOptionPane.WARNING_MESSAGE);
                } else {
