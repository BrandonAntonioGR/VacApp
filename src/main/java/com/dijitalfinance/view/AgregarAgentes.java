...
public class AgregarAgentes extends javax.swing.JFrame {
    ...
    public AgregarAgentes(String agente, String area) {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtFechaIngreso, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jLabel5.setText("Ingresa colaborador");
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        cp.administrarAgentes(agnt, adminArea);
        this.dispose();
    }//GEN-LAST:event_btnRegresarActionPerformed
    public int calculaDiasVacacionesTotalesHoy(Date fechaingreso) {
        int diasDeVacaciones = 0;
        LocalDate fechaHoy = LocalDate.now();

        //----------ONTENER DIFERENCIA EN MESES
        // Convertir java.util.Date a java.time.LocalDate
        LocalDate fechaIngresoMeses = fechaingreso.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        // Calcular la diferencia en meses
        Period periodoMeses = Period.between(fechaIngresoMeses, fechaHoy);
        int diferenciaMeses = periodoMeses.getMonths() + periodoMeses.getYears() * 12;
//        System.out.println("La diferencia en meses es: " + diferenciaMeses);

        //----------ONTENER DIFERENCIA EN AÑOS
        // Convertir java.util.Date a java.time.LocalDate
        LocalDate fechaIngresoAnios = fechaingreso.toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
        // Calcular la diferencia en años
        Period periodoAnios = Period.between(fechaIngresoAnios, fechaHoy);
        int diferenciaAnios = periodoAnios.getYears();
//        System.out.println("La diferencia en años es: " + diferenciaAnios);

        if (diferenciaMeses >= 6) {
            diasDeVacaciones = diasDeVacaciones + 6;
//            System.out.println("1Los dias de vacaciones son: " + diasDeVacaciones);
            if (diferenciaMeses >= 12) {
                diasDeVacaciones = diasDeVacaciones + 6;
//                System.out.println("2Los dias de vacaciones son: " + diasDeVacaciones);
                if (diferenciaAnios == 2) {
                    diasDeVacaciones = diasDeVacaciones + 2;
//                    System.out.println("3Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios == 3) {
                    diasDeVacaciones = diasDeVacaciones + 4;
//                    System.out.println("4Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios == 4) {
                    diasDeVacaciones = diasDeVacaciones + 6;
//                    System.out.println("5Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios == 5) {
                    diasDeVacaciones = diasDeVacaciones + 8;
//                    System.out.println("6Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios >= 6 && diferenciaAnios <= 10) {
                    diasDeVacaciones = diasDeVacaciones + 10;
//                    System.out.println("7Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios >= 11 && diferenciaAnios <= 15) {
                    diasDeVacaciones = diasDeVacaciones + 12;
//                    System.out.println("8Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios >= 16 && diferenciaAnios <= 20) {
                    diasDeVacaciones = diasDeVacaciones + 14;
//                    System.out.println("9Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios >= 21 && diferenciaAnios <= 25) {
                    diasDeVacaciones = diasDeVacaciones + 16;
//                    System.out.println("10Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios >= 26 && diferenciaAnios <= 30) {
                    diasDeVacaciones = diasDeVacaciones + 18;
//                    System.out.println("11Los dias de vacaciones son: " + diasDeVacaciones);
                } else if (diferenciaAnios >= 31 && diferenciaAnios <= 35) {
                    diasDeVacaciones = diasDeVacaciones + 20;
//                    System.out.println("12Los dias de vacaciones son: " + diasDeVacaciones);
                }
            }

        } else {
            diasDeVacaciones = 0;
//            System.out.println("13Los dias de vacaciones son: " + diasDeVacaciones);
        }
//        System.out.println("El resultado es: " + diasDeVacaciones);
...
//            System.out.println("Formato de fecha incorrecto DD/MM/YYYY");
            ...
            String idAgente = adminArea + ":" + Nombre + ":" + CreateDate + ":" + sqlDateFechaIngreso;
            agnt.setIdagente(idAgente);
            //nombre
            agnt.setAgente(Nombre);
            agnt.setArea(adminArea);
            agnt.setVacacionesPorAnio(calculaDiasVacacionesTotalesHoy(fechaingreso));
            agnt.setVacacionesTomadas(0);
            agnt.setVacacionesDisponibles(calculaDiasVacacionesTotalesHoy(fechaingreso));
            insertaragente.CargarAgente(agnt);
            this.dispose();
            cp.administrarAgentes(this.agnt, adminArea);
        }
